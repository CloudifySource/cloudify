...
import org.cloudifysource.dsl.internal.context.ServiceContextMock;
...
public final class ServiceContextFactory {
    ...
    public static synchronized ServiceContext getServiceContext() {
        ...
        if (context == null) {
            if(!Boolean.getBoolean("debug.local")){
                ...
                logger.warning("ACTIVATED LOCAL DEBUG MODE!!!");
                context = new ServiceContextMock();
            }
        }
        return context;
    }
