...
public class UserInterfaceConverter {
	...
	private final Unit DEFAULT_AXIS_Y_UNIT = Unit.REGULAR;
	private final String DEFAULT_WIDGET_GROUP_NAME = " default name";
	private final String DEFAULT_WIDGET_TITLE_NAME = " default title";
