 ...
 */
@Command(scope = "cloudify", name = "remove-attributes",
		description = "Removes attributes from the cloudify controller attribute store")
public class RemoveAttributes extends AbstractAttributesCommand {

	@Argument(required = true, name = "attributes", description = "A list of one or more attributes names to delete. "
			+ "List should use the following format: 'att1,att2' (make sure to use single quotes (') around "
