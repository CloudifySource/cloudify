 ...
 *         force - When specified, the agent shuts down even when running service instances on local machine.
 * 
 ...
 */
@Command(scope = "cloudify", name = "shutdown-agent", description = "Shuts down the agent running on the local "
		+ "machine.")
