...
public abstract class AbstractGSCommand implements Action {
	...
	/**
	 * Sets the restAdminFacade.
	 * 
	 * @param restAdminFacade
	 *            The AdminFacade object to be used by rest commands
	 */
	public static void setRestAdminFacade(final AdminFacade restAdminFacade) {
