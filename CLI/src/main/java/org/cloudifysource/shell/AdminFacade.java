 ...
 * @since 2.0.0
 *        <p/>
 *        This interface defines a set of commands that need to be implemented
 *        by an AdminFacade. These commands mainly deal with the installation of
 *        applications and service, execution of custom commands and gathering
 *        information about the current deployment status.
 */
public interface AdminFacade {
	 ...
	 * @throws CLIException
	 *             Reporting a failure to install or start the given service on
	 ...
	 * application name. Contained services are also installed, ordered
	 ...
	 * @throws CLIException
	 *             Reporting a failure to create temporary files or post the
	 *             file over REST
	 */
	 ...
	 * @throws CLIException
	 *             Reporting a failure to remove a processing unit instance of
	 *             this service
	 */
	 ...
	 * @throws CLIException .
	 */
	void restart(ComponentType componentType, String componentName,
			Set<Integer> componentIDs) throws CLIException;
	 ...
	 * 
	 * @param applicationName
	 *            The name of the application the service is currently deployed
	 *            in
	 * @param serviceName
	...
	/**
	 * Returns a Map of deployed instances (name-object) of the given services
	...
	/**
	 * Invokes a custom command on all of the specified service instances, on
	 * the given application. Custom parameters are passed as a map using the
	 * POST method and contain the command name and parameter values for the
	 * specified command.
	 * 
	 * @param applicationName
	 *            The name of the application
	 ...
	 *         instance
	 * @throws CLIException
	 *             Reporting a failure to execute the custom command on the
	 *             specified service
	 */
	...
	/**
	 * Invokes a custom command on a specific service instance, on the given
	 * application. Custom parameters are passed as a map using the POST method
	 * and contain the command name and parameter values for the specified
	 * command.
	 * 
	 * @param applicationName
	 *            The name of the application
	 ...
	 * @param timeout
	 *            The time (number of minutes) this procedure is limited to,
	 *            before throwing an exception
	 ...
	 * @return The last n lines of log of the requested service according to
	 *         it's instance id.
	 * @throws CLIException
	 *             a CLI exception is thrown if an error occurred on the remote
	 *             server.
	 */
	...
	/**
	 * Retrieves the tail of a service log. This method used the service name
	 * and the instance host address To retrieve the the instance log tail.
	 * 
	 * @param applicationName
	 *            The application name.
	 * @param serviceName
	 ...
	 * @param numLines
	 *            The number of lines to tail.
	 * @return The last n lines of log of the requested service instance
	 *         according to it's host address.
	 * @throws CLIException
	 *             a CLI exception is thrown if an error occurred on the remote
	 *             server.
	 */
	 ...
	 *            (which will apply to the current application),
	 *            "service:<service name>" (which will apply to the service with
	 *            the given name for of the given application), or
	 *            "service:<service name>:<instance id>" (which will apply to
	 *            the instance with the give ID of the given service of the
	 *            given application)
	 * @param applicationName
	 *            The applicatio name
	 * @param attributes
