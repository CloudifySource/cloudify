...
:SET_CLOUDIFY_JAVA_OPTIONS
	...
	set CLOUDIFY_JAVA_OPTIONS=-Xmx500m -Dcom.gigaspaces.logger.RollingFileHandler.debug-level=WARNING -Dcom.gigaspaces.client.router.disableNewRouter=true %PROXY_JAVA_OPTIONS% %EXT_CLOUDIFY_JAVA_OPTIONS%
