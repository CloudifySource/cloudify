...
abstract public class AzureConfigExe {
	 ...
	 */
	public AzureConfigExe(File azureConfigExeFile, File encUtilExeFile, String subscriptionId, String certificateThumbprint, boolean verbose) {
