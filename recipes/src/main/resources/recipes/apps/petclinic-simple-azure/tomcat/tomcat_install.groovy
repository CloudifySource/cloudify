...
def usersXmlFile = new File("${home}/conf/tomcat-users.xml") 
def usersXmlText = usersXmlFile.text	
usersXmlText = usersXmlText.replace("<tomcat-users>","<tomcat-users><role rolename=\"manager-gui\"/><user username=\"admin\" password=\"admin\" roles=\"manager-gui\"/>")
usersXmlFile.write(usersXmlText)
