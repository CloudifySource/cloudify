...
/******
 * Webui configuration POJO.
 * 
 * @author adaml
 * @since 2.5.0
 */

@CloudifyDSLEntity(name = "webui", clazz = WebuiComponent.class, allowInternalNode = true,
allowRootNode = false, parent = "components")
public class WebuiComponent extends GridComponent {
