...
public class ManagementSpacePUTest {
    ...
    private final ApplicationCloudifyAttribute applicationCloudifyAttribute = new ApplicationCloudifyAttribute("app", "app", "app");
    private final ServiceCloudifyAttribute serviceCloudifyAttribute = new ServiceCloudifyAttribute("app","service","service", "service");
    private final InstanceCloudifyAttribute instanceCloudifyAttribute = new InstanceCloudifyAttribute("app", "service", 1, "instance", "instance");
    private final CloudConfigurationHolder cloudConfigurationHolder = new CloudConfigurationHolder("cloudConfig", "cloudConfigPath");
