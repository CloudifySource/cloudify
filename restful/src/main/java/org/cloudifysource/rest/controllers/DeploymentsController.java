 ...
 * It is also the entry point for deploying services and application.
 * <br><br>
 * The response body will always return in a JSON representation of the {@link Response} Object.
 * <br>
 * A controller method may return the {@link Response} Object directly. in this case this return value will 
 * be used as the response body.
 * Otherwise, an implicit wrapping will occur. the return value will be inserted into {@code Response#setResponse(Object)}. 
 * other fields of the {@link Response} object will be filled with default values. 
 * <br>
 * <h1>Important</h1> {@code @ResponseBody} annotations are not permitted. <br><br>
 * <h1>Possible return values</h1> 200 - OK, 400 - controller throws an exception, 500 - Unexpected exception
 * 
...
public class DeploymentsController {
	...
	public void setApplicationAttributes(
		...
		final AbstractCloudifyAttribute[] attributesToWrite = new AbstractCloudifyAttribute[attributesRequest.getAttributes().size()];
		int i = 0;
		for (final Entry<String, Object> attrEntry : attributesRequest.getAttributes().entrySet()) {
			final AbstractCloudifyAttribute newAttr = createCloudifyAttribute(appName,
					null, null, attrEntry.getKey(), null);
	...
	public Response<DeleteServiceInstanceAttributeResponse> deleteServiceInstanceAttribute(
		...
		final InstanceCloudifyAttribute attribute = new InstanceCloudifyAttribute(appName, serviceName,
		...
		DeleteServiceInstanceAttributeResponse deleteServiceInstanceAttributeResponse = new DeleteServiceInstanceAttributeResponse();
		...
		Response<DeleteServiceInstanceAttributeResponse> response = new Response<DeleteServiceInstanceAttributeResponse>();
		
		response.setMessageId(CloudifyMessageKeys.ATTRIBUTE_DELETED_SUCCESSFULLY.getName());
		response.setMessage(messageSource.getMessage(CloudifyMessageKeys.ATTRIBUTE_DELETED_SUCCESSFULLY.getName(), new Object[] {attributeName}, Locale.getDefault()));
	...
	public void handleExpectedErrors(final HttpServletResponse response,
		...
		String formattedMessage = messageSource.getMessage(messageId, messageArgs, Locale.getDefault());
