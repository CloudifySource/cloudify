...
/**
 * This class tests different calls (get/post) to the attributes controller web service, over REST. The new
 * spring REST testing framework is being used.
 *
 * @author noak
 */
...
public class AttributesContollerTests {
     ...
     *
     * @throws NoSuchMethodException Indicates the defined {@link HandlerMethod} does not exist
     */
    @Before
    public void init() throws NoSuchMethodException {
        handlerAdapter = applicationContext.getBean(RequestMappingHandlerAdapter.class);
        controller = applicationContext.getBean(AttributesController.class);

        // TODO: this is a temporary solution. need to get the methods list from the handler mapping somehow.
        ...
        singleGlobalAttributeHandlers.put(HTTP_GET, new HandlerMethod(controller, "getGlobalAttribute", String.class));
        singleGlobalAttributeHandlers.put(HTTP_POST, new HandlerMethod(controller, "setGlobalAttribute", String.class,
                Object.class));
        singleGlobalAttributeHandlers.put(HTTP_DELETE, new HandlerMethod(controller, "deleteGlobalAttribute",
                String.class));
        ...
        multipleGlobalAttributesHandlers.put(HTTP_POST,
        ...
        singleApplicationAttributeHandlers.put(HTTP_GET, new HandlerMethod(controller, "getApplicationAttribute",
                String.class, String.class));
        singleApplicationAttributeHandlers.put(HTTP_POST, new HandlerMethod(controller, "setApplicationAttribute",
                String.class, String.class, Object.class));
        singleApplicationAttributeHandlers.put(HTTP_DELETE, new HandlerMethod(controller, "deleteApplicationAttribute",
                String.class, String.class));
        ...
        multipleApplicationAttributesHandlers.put(HTTP_GET, new HandlerMethod(controller, "getApplicationAttributes",
                String.class));
        multipleApplicationAttributesHandlers.put(HTTP_POST, new HandlerMethod(controller, "setApplicationAttributes",
                String.class, Map.class));
        multipleApplicationAttributesHandlers.put(HTTP_DELETE, new HandlerMethod(controller,
                "deleteApplicationAttributes", String.class));
        ...
        singleServiceAttributeHandlers.put(HTTP_GET, new HandlerMethod(controller, "getServiceAttribute",
        ...
        singleServiceAttributeHandlers.put(HTTP_DELETE, new HandlerMethod(controller, "deleteServiceAttribute",
                String.class, String.class, String.class));
        ...
        multipleServiceAttributesHandlers.put(HTTP_GET, new HandlerMethod(controller, "getServiceAttributes",
                String.class, String.class));
        multipleServiceAttributesHandlers.put(HTTP_POST, new HandlerMethod(controller, "setServiceAttributes",
                String.class, String.class, Map.class));
        multipleServiceAttributesHandlers.put(HTTP_DELETE, new HandlerMethod(controller, "deleteServiceAttributes",
                String.class, String.class));
        ...
        final String multipleInstanceAttributesUri = "/attributes/instances/" + APPLICATION_NAME + "/" + SERVICE_NAME
                + "/" + INSTANCE_ID;
        final HashMap<String, HandlerMethod> multipleInstanceAttributesHandlers = new HashMap<String, HandlerMethod>();
        multipleInstanceAttributesHandlers.put(HTTP_GET, new HandlerMethod(controller, "getInstanceAttributes",
        ...
        multipleInstanceAttributesHandlers.put(HTTP_DELETE, new HandlerMethod(controller, "deleteInstanceAttributes",
                String.class, String.class, int.class));
    ...
    /**
     * Test GET & POST calls for getting or setting a single attribute, in all 4 scopes (global, application,
     * service & instance).
     *
     * @throws Exception Indicates the GET / POST call failed.
     */
    ...
    /**
     * Test GET & POST calls for getting or setting multiple attributes at once, in all 4 scopes (global,
    ...
    private void testUriForSingleAttribute(final String requestUri, final Object attrInitialValue,
        ...
        // Expecting null attribute value in return (the attribute does not exists yet).
        reqeust = createMockGetRequest(requestUri);
        testRequest(reqeust, uriHandlers.get(HTTP_GET), convertToJson(expectedMap));

        // Set the attribute.
        // Expecting null attribute value in response content (post returns the previous attribute value).
        ...
        // Expecting the @attributeValue parameter as the response attribute value.
     ...
     * @throws Exception Indicates a matching handler could not be found
     */
     ...
     *
     * @param jsonStr a json-format String to convert to a map
     * @return a Map<String, Object> based on the given json-format String
     * @throws IOException Reporting failure to read or convert the json-format string to a map
     */
     ...
     */
    // private static String mapToJson(final Map<String, ?> map) throws IOException {
     ...
     */
    // private static String jsonToString(final String jsonStr) throws IOException {
     ...
     *             Reporting failure to read the string value or convert it
     */
    // private static String stringToJson(final String strValue) throws IOException {
     ...
     *
     * @param value an object to convert to json-format String
     * @return a json-format String based on the given object
     * @throws IOException Reporting failure to convert the object
     */
