...
@ContextConfiguration({ "classpath:META-INF/spring/applicationContext.xml",
		"file:src/test/webapp/WEB-INF/spring/webmvc-config-test.xml" })
public class AttributesContollerTest {
	 ...
	 */
	 ...
	 @Test public void testSingleAttribute() throws Exception {
	...
	private void testUriForMultipleAttributes(final String requestUri, final Object attrInitialMap,
			final Object attrUpdatedMap) throws Exception {
		...
		testRequest(reqeust, uriHandlers.get(HTTP_POST), convertToJson(new HashMap<String, Object>()));

		// Set the attribute again.
		// Expecting the @attributeValue parameter as the response attribute value.
		reqeust = createMockPostRequest(requestUri, convertToJson(attrUpdatedMap));
		testRequest(reqeust, uriHandlers.get(HTTP_POST), convertToJson(attrInitialMap));
