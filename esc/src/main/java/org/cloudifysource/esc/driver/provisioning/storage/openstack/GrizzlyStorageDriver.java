...
public class GrizzlyStorageDriver extends BaseStorageDriver implements StorageProvisioningDriver {
	...
	private static final String OPENSTACK_ENDPOINT_PROPERTY = "openstack.endpoint";
	...
	private static final java.util.logging.Logger logger = java.util.logging.Logger
			.getLogger(GrizzlyStorageDriver.class.getName());
	...
	/*public static void main(String[] args) {
		GrizzlyStorageDriver grizzlyDriver = new GrizzlyStorageDriver();
		//Cloud cloud = new Cloud();
		try {
			grizzlyDriver.testCreateVolume("region-b.geo-1", "testVolume");
...
//
//        if (overrides == null) {
//        	throw new IllegalArgumentException("Compute template " + computeTemplateName + " is missing "
//        			+ "an \"overrides\" section with the required property \"" + OPENSTACK_ENDPOINT_PROPERTY  + "\"");
//        }
//        
//        Object endpointObj = overrides.get(OPENSTACK_ENDPOINT_PROPERTY);
//        if (endpointObj instanceof String) {
//        	String endpoint = (String) endpointObj;
//        	if (StringUtils.isBlank(endpoint)) {
//				throw new IllegalArgumentException("Compute template custom overrides is missing or empty: " 
//						+ OPENSTACK_ENDPOINT_PROPERTY);
//			}
//        } else {
//        	throw new IllegalArgumentException("Compute template overrides property \"" + OPENSTACK_ENDPOINT_PROPERTY 
//					+ "\" is missing or not a String"); 
//        }
//        
//        String endpoint = (String) overrides.get(OPENSTACK_ENDPOINT_PROPERTY);
//        if (StringUtils.isBlank(endpoint)) {
//        	// TODO noak: throw better
//        	throw new IllegalArgumentException("endpoint is missing in template: " + computeTemplateName);
//        }
