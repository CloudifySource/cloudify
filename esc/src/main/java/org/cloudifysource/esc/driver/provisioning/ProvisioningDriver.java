...
public interface ProvisioningDriver {
	 ...
	 * @param serviceName The name of the service that is planned to be installed on this machine. 
	 * 			          Could be null if this is a management machine hosting more than one service
	 * 
	 */
	 ...
	 * 
	 * @param admin an instance of the Admin API, running in single threaded mode.
	 */
	 ...
	 * 
	 * @param machineIp host-name/IP of the machine to shut down.
	 ...
	 * @throws TimeoutException If the operation exceeded the given timeout.
	 * @throws CloudProvisioningException If the operation encountered an error.
	 */
	 ...
	 * events.
	 * 
	 * @param listener A class that implements ProvisioningDriverListner.
	 */
