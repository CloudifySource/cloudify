 ...
 * 
 * - org.openspaces.cloud.esm: The implementation of the ESM machine provisioning interface and
 * supporting classes.
 * - org.openspaces.cloud.jclouds: Service facade around the jclouds framework, exposing only
 * the functionality used to scale in and out as required by the ESM.
 * - org.openspaces.cloud.jclouds: Examples of usage of this project in various clouds and
