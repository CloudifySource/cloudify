		...
		templates ([
					...
					SMALL_LINUX : computeTemplate {
						...
						overrides ([
							...
							"jclouds.softlayer.hardware.disk-controller" : diskControllerID ,  // RAID 1 OR non-RAID1 
					...
					LARGE_LINUX : computeTemplate {
						...
						overrides ([
							// additional disks, 7 in total.
							"jclouds.softlayer.external-disks-ids":largeLinuxOtherHardDisksIDs,
							"jclouds.softlayer.package-id":packageId, // Use Bare Metal Servers Package or not (44 is BM)	
							"jclouds.softlayer.hardware.disk-controller" : diskControllerID ,  // RAID 1 OR non-RAID1
							"jclouds.so-timeout" : 600000 ,
							"jclouds.connection-timeout" : 600000,
